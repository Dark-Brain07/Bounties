...
"""
BOUNTIES -- an onchain marketplace for verifiable public claims,
...
payout via `payout_bps` (see `_collect_verdict`), matching BOUNTIES's
...
"""BOUNTIES explicitly supports both "prove this succeeded" (POSITIVE)
and "prove this failed/violated its own rules" (NEGATIVE) claims -- see
BOUNTIES.md section 17. Purely informational/filterable; does not change
...
class Bounty:
    ...
    evidence requirements immutable exactly when BOUNTIES.md requires
...
class Reputation:
    ...
    settled protocol events -- never self-reported (BOUNTIES.md section
...
#
# Every payout in BOUNTIES goes to a bounty's creator/challenger/treasury
...
class Bounties(gl.Contract):
    """
    BOUNTIES protocol: financially-backed claims settled by GenLayer's
    ...
    def _collect_verdict(
        ...
        def run_review() -> str:
            ...
            prompt = f"""
You are an impartial adjudicator for BOUNTIES, a platform where a
...
"""
    ...
    def _collect_appeal_verdict(
        ...
        def run_review() -> str:
            ...
            prompt = f"""
You are the FINAL, binding appeal adjudicator for BOUNTIES. A financial
    ...
    def create_bounty(
        ...
        Args:
            ...
            claim_polarity: "POSITIVE" (prove success) or "NEGATIVE" (prove
                failure/violation) -- see BOUNTIES.md section 17.
